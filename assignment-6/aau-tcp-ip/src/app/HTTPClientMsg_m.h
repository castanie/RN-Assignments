...
class HTTPClientMsg;
/**
 * Class generated from <tt>app/HTTPClientMsg.msg:20</tt> by opp_msgtool.
 * <pre>
 * packet HTTPClientMsg
 * {
 *     // TODO define HTTPClientMsg comprising at least a method and resource field
 *     string method;
 *     string resource;
 * }
 * </pre>
...
class HTTPClientMsg : public ::omnetpp::cPacket
{
  ...
  protected:
    bool operator==(const HTTPClientMsg&) = delete;
...
template<> inline HTTPClientMsg *fromAnyPtr(any_ptr ptr) { return check_and_cast<HTTPClientMsg*>(ptr.get<cObject>()); }
